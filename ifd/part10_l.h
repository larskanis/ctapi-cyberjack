...
/* The definitions in this file have been copied from the PC/SC file
 * "reader.h".
 */

#ifndef CYBERJACK_PART10_L_H
#define CYBERJACK_PART10_L_H
...
#define FEATURE_MCT_READER_DIRECT 0x08 /**< KOBIL Proposal */
